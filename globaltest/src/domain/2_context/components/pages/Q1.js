...
const ContextQ1Page = () => {
  /* 
        ...
        src/store/2_context.js 파일에 context를 구현해주세요
    */
  ...
  */
  ...
  let text = isModalOpen ? "숨기기" : "보이기"

  const onSetModalChange = () => {
  ...
  return (
    <div>
      ...
      <h2>문제 2 - 1</h2>
      <ContextQ1Detail onSetModalChange={onSetModalChange} text={text} />
